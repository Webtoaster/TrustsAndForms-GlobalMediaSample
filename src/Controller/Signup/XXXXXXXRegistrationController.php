...
class XXXXXXXRegistrationController extends BaseController
{
    ...
    #[Route('/register', name: 'reg_register')]
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                $this->emailVerifier->sendEmailConfirmation(
                    ...
                    $user,
                    (new TemplatedEmail())
                        ->from(new Address('admin@iGunTrust.com', 'iGunTrust Administrator'))
                        ->to($user->getEmail())
